...
/*View issue accordion*/
 $scope.groups2 = [];
  $scope.groups2 = [
    { name: 'Engage people', stars:'0/10 stars', id: 1, items: [{ subName: 'SubBubbles1', subId: 'Identify concerned or affected people.' }, { subName: 'SubBubbles2', subId: 'Get School Head to confirm issue.'}]},
    { name: 'Access information', stars:'0/15 stars', id: 1, items: [{ subName: 'SubGrup1', subId: 'Identify needed information' }, { subName: 'SubGrup1', subId: 'Request and access identified information' },{ subName: 'SubGrup1', subId: 'Review information' },{ subName: 'SubGrup1', subId: 'Analyze issue based on information' }]},
